...
"Voice Memos")
	...
	;;
"Messages"| "QQ" | "WeChat" | "Slack" | "Microsoft Teams" | "Discord" | "Telegram")
	RESULT=$ICON_CHAT
	;;
...
"Photo Booth")
	RESULT=$ICON_CAMERA
	;;
"Safari浏览器"| "Safari" | "Beam" | "DuckDuckGo" | "Arc" | "Microsoft Edge" | "Google Chrome" | "Firefox")
	RESULT=$ICON_WEB
	;;
"System Settings"| "系统设置" | "System Information" | "TinkerTool")
	RESULT=$ICON_COG
	;;
"HOME")
